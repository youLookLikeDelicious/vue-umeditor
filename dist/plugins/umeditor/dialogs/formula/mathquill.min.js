...
function mathquillV10() {
    ...
    function c(e) {
        ...
        s = {}, n.L = Tt, n.R = Ct, n.config = function (t) {
            ...
            e.__mathquillify = function () {
                ...
                var i, s = t - _t(window).scrollLeft(),
                    r = e - _t(window).scrollTop(),
    ...
    function p(t, e) {
        t.jQadd = function () {
            ...
            K(this.delimjQs, yt(1 + .3 * (t - 1), 1.4), 1.2 * t)
        }
    }
    ...
    var m, g, b, v, w, q, x, y, O, k, j, Q, T, C, _, D, S, L, E, A, R, I, z, M, B, F, $, N, P, U, W, H, G, K, Y, X, Z, V, J, tt, et, nt, it, st, rt, ot, at, lt, ct, ut, ht, ft, pt, dt, bt, mt, gt, xy, vt, wt = window.jQuery,
        ...
        Qt = function (t, e, n) {
            ...
            return function o(a, l) {
                ...
                return l === n && (l = a, a = Object), c.Bare = u, h = r[t] = a[t], f = u[t] = c[t] = c.p = new r, f.constructor = c, c.extend = function (t) {
                    ...
                    if (p = {}, s(t) ? p = t.call(c, f, h, c, a) : i(t) && (p = t), i(p))
                        for (var n in p) e.call(p, n) && (f[n] = p[n]);
        ...
        St = Qt(function (t) {
            ...
            this.byId = {}, t.init = function () {
                ...
                var n;
                for (t = _t(t || this.html()), n = 0; n < t.length; n += 1) e(t[n]);
                return t
        ...
        Rt = Qt(Dt, function (t) {
            t.init = function (t, e) {
                ...
                var t, e = this.anticursor = Dt.copy(this),
                    n = e.ancestors = {};
                ...
                for (t = this; t.parent; t = t.parent)
                    if (t.parent.id in l.ancestors) {
                        e = t.parent;
                        break
                    } if (s("cursor and anticursor in the same tree", e), n = l.ancestors[e.id], o = Ct, t[Tt] !== n)
                    for (a = t; a; a = a[Ct])
                        if (a[Ct] === n[Ct]) {
                            o = Tt, i = t, r = n;
                            break
    ...
    l.prototype = $t.p, l.interfaceVersion = function (t) {
            ...
            t.focusBlurEvents = function () {
                ...
                function e() {
                    r.hide().parent.blur(), i.container.removeClass("mq-focused"), _t(window).off("blur", t)
                }
                var n, i = this,
                    s = i.root,
                    r = i.cursor;
            ...
            t.exportLatex = function () {
                ...
                var e, n, i, s, r, o, a, l, c, u, h = this.root,
                    f = this.cursor;
            ...
            Bt.p.ignoreNextMousedown = t, e.delegateMouseEvents = function () {
                ...
                this.container.bind("mousedown.mathquill", function (n) {
                    ...
                    var o, a = _t(n.target).closest(".mq-root-block"),
            ...
            t.scrollHoriz = function () {
                ...
                } else if (t = r.jQ[0].getBoundingClientRect().left, t > a.right - 20) e = t - (a.right - 20);
                else {
            ...
            Bt.p.substituteTextarea = function () {
                ...
                var t, e = this.textareaSpan = _t('<span class="mq-textarea"></span>'),
            ...
            t.ctrlSeq = "\\text", t.replaces = function (t) {
                ...
                var n, i = this;
                if (e.createLeftOf.call(this, t), i[Ct].siblingCreated && i[Ct].siblingCreated(t.options, Tt), i[Tt].siblingCreated && i[Tt].siblingCreated(t.options, Ct), i.bubble("reflow"), t.insAtRightEnd(i), i.replacedText)
            ...
            t.keystroke = function (t) {
                ...
                if (t.show().deleteSelection(), "$" === e) S(t).createLeftOf(t);
                else {
                    var n;
            ...
            t.init = function (t) {
                ...
                if (e.createLeftOf.apply(this, arguments), n = t.options.autoCommands, i = n._maxLength, i > 0) {
                    for (s = "", r = this, o = 0; r instanceof R && r.ctrlSeq === r.letter && i > o;) s = r.letter + s, r = r[Tt], o += 1;
                    for (; s.length;) {
                ...
                var e, i, s, r, o, a, l, c, u, h, f, p, d, m = t.autoOperatorNames;
                if (0 !== m._maxLength) {
                    for (e = this.letter, i = this[Tt]; i instanceof R; i = i[Tt]) e = i.letter + e;
                    for (s = this[Ct]; s instanceof R; s = s[Ct]) e += s.letter;
        ...
        function () {
            ...
            for (t = 0; t < s.length; t += 1) I[s[t]] = z[s[t]] = 1;
            for (e = "sin cos tan arcsin arccos arctan sinh cosh tanh sec csc cot coth".split(" "), t = 0; t < e.length; t += 1) I[e[t]] = 1;
            for (n = "sin cos tan sec cosec csc cotan cot ctg".split(" "), t = 0; t < n.length; t += 1) z[n[t]] = z["arc" + n[t]] = z[n[t] + "h"] = z["ar" + n[t] + "h"] = z["arc" + n[t] + "h"] = 1;
            for (i = "gcf hcf lcm proj span".split(" "), t = 0; t < i.length; t += 1) z[i[t]] = 1
            ...
            t.init = function (t) {
                ...
                for (e = 0; e < n.length; e += 1) R(n.charAt(e)).createLeftOf(t)
            }, t.parser = function () {
                var t, e = this.ctrlSeq,
                    n = T();
                for (t = 0; t < e.length; t += 1) R(e.charAt(t)).adopt(n, n.ends[Ct], 0);
                return w.succeed(n.children())
            }
        });
    for (F in z) z.hasOwnProperty(F) && (Et[F] = B);
    ...
    }), Et["="] = G, Et["×"] = Et.times = i(Q, "\\times ", "&times;", "[x]"), Et["÷"] = Et.div = Et.divide = Et.divides = i(Q, "\\div ", "&divide;", "[/]"), At["~"] = Et.sim = i(Q, "\\sim ", "~", "~"), Y = t, X = document.createElement("div"), Z = X.style, V = {
        transform: 1,
        WebkitTransform: 1,
        MozTransform: 1,
        OTransform: 1,
    ...
    for (tt in V)
        ...
        var s, r;
        e /= 1 + (n - 1) / 2, t.css("fontSize", n + "em"), t.hasClass("mq-matrixed-container") || t.addClass("mq-matrixed-container").wrapInner('<span class="mq-matrixed"></span>'), s = t.children().css("filter", "progid:DXImageTransform.Microsoft.Matrix(M11=" + e + ",SizingMethod='auto expand')"), i(), r = setInterval(i), _t(window).load(function () {
            clearTimeout(r), i()
        })
    }) : K = function (t, e, n) {
        t.css("fontSize", n + "em")
        ...
        t.ctrlSeq = "_{...}^{...}", t.createLeftOf = function (t) {
            ...
            for (e = Tt; e; e = e === Tt ? Ct : !1)
                if (this[e] instanceof st) {
                    for (n = "sub"; n; n = "sub" === n ? "sup" : !1) i = this[n], s = this[e][n], i && (s ? i.isEmpty() ? o = Dt(s, 0, s.ends[Tt]) : (i.jQ.children().insAtDirEnd(-e, s.jQ), r = i.children().disown(), o = Dt(s, r.ends[Ct], s.ends[Tt]), e === Tt ? r.adopt(s, s.ends[Ct], 0) : r.adopt(s, 0, s.ends[Tt])) : this[e].addBlock(i.disown()), this.placeCursor = function (t, n) {
                        return function (i) {
                            i.insAtDirEnd(-e, t || n)
                        }
                    }(s, i));
        ...
        e.init = function (t, e, i, s, r) {
            ...
            if (i = n.options, s = !this.side, this.side = -t, this.oppBrack(i, this.ends[Tt].ends[this.side], t)) this.closeOpposing(this.ends[Tt].ends[this.side]), r = this.ends[Tt].ends[t], this.unwrap(), r.siblingCreated && r.siblingCreated(n.options, t), a ? n.insDirOf(-t, a) : n.insAtDirEnd(t, o);
            else {
                if (this.oppBrack(i, this.parent.parent, t)) this.parent.parent.closeOpposing(this), this.parent.parent.unwrap();
                else {
