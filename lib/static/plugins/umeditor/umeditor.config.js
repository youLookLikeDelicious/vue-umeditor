...
(function () {
  ...
  window.UMEDITOR_CONFIG = {
    ...
    UMEDITOR_HOME_URL: '/plugins/umeditor/',
    allowSyn: true //图片上传配置区
    ,
    ...
    ,
    toolbar: ['source | undo redo | bold italic underline strikethrough | superscript subscript | forecolor backcolor | removeformat |', 'insertorderedlist insertunorderedlist | selectall cleardoc paragraph | fontfamily fontsize', '| justifyleft justifycenter justifyright justifyjustify |', 'link unlink | emotion image video  | map', '| horizontal print preview fullscreen', 'drafts', 'formula', '| code'] //语言配置项,默认是zh-cn。有需要的话也可以使用如下这样的方式来自动多语言切换，当然，前提条件是lang文件夹下存在对应的语言文件：
    ...
    //填写过滤规则
    ,
    filterRules: {} // xss 过滤是否开启,inserthtml等操作
    ,
    ...
    whiteList: {
      ...
      hr: ['style', 'class', 'id'],
      i: ['style', 'class', 'id'],
      iframe: ['style', 'class', 'id', 'src', '_src', 'frameborder', 'data-latex', 'srcdoc'],
